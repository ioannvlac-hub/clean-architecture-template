...
The project was generated using the [CleanArchitecture.Template](caRepositoryUrl) version caPackageVersion.
...
```bash
dotnet new install CleanArchitecture.Template::caPackageVersion
```
